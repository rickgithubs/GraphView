...
function make_slug($z){
//intended to make slugs in the following style:
//http://www.thewebsitetailor.com/jquery-slug-plugin/
//so that we can use that for displaying later...
// mostly from http://stackoverflow.com/questions/3022185/regular-expression-sanitize-php
    $z = strtolower($z);
